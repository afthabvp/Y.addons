...
import com.accenture.constants.DataremovaladdonConstants;



/**
 * This is the extension manager of the Dataremovaladdon extension.
 */
public class DataremovaladdonManager extends GeneratedDataremovaladdonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(DataremovaladdonManager.class.getName());
	 ...
	 */
	public static DataremovaladdonManager getInstance()
	{
		return (DataremovaladdonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				DataremovaladdonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public DataremovaladdonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of DataremovaladdonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of DataremovaladdonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of DataremovaladdonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
