			...
			<c:if test="${not empty wishlist.entries}">
				...
				<tr>
					<td colspan="2">
						<div id="caurosel_block">
                 		<div class="left_arrow">
                 			<a href="#"><img src="${commonResourcePath}/../../addons/qrcodeaddon/desktop/common/bnc_images/arrow_left.png" alt="" border="0"/></a>
                 		</div>
                 		<div class="caurosel_center_block">
                 		...
                 		<div class="right_arrow">
                 			<a href="#"><img src="${commonResourcePath}/../../addons/qrcodeaddon/desktop/common/bnc_images/arrow_right.png" alt=""  border="0"/></a>
                 		</div>
               		</div>
					</td>
				</tr>
