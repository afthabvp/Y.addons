...
<div id="head">
	<div class="contain_block">
		...
		<div class="sitename">Orders Dashboard</div>
		<div class="username_blk">
			...
			<div class="userblock">
				<div class="user_photo"><img src="${commonResourcePath}/../../addons/qrcodeaddon/mobile/common/bnc_images/user_photo.png" alt=""/></div>
				...
				<ol>
					<li>
						<a href="#" onClick="redirectToCustomersDashboard()" style="border-top:1px solid #494949"   >
							<img src="${commonResourcePath}/../../addons/qrcodeaddon/mobile/common/bnc_images/dashboard_icon.png" alt=""/>
					...
					<li>
						<a href="#">
							<img src="${commonResourcePath}/../../addons/qrcodeaddon/mobile/common/bnc_images/search_icon.png" alt=""/>
							<span class="singleline">Search</span>
						</a>
					</li>
					<li>
						<a href="#">
							<img src="${commonResourcePath}/../../addons/qrcodeaddon/mobile/common/bnc_images/notification_icon.png" alt=""/>
							<span class="singleline">Notifications</span>
						</a>
					</li>
					<li>
						<a href="#">
							<img src="${commonResourcePath}/../../addons/qrcodeaddon/mobile/common/bnc_images/myteam_icon.png" alt=""/>
							<span class="singleline">My Team</span>
						</a>
					</li>
					<li>
						<a href="#">
							<img src="${commonResourcePath}/../../addons/qrcodeaddon/mobile/common/bnc_images/mytargets_icon.png" alt=""/>
