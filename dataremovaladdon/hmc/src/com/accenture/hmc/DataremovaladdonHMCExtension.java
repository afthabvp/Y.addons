...
/**
 * Provides necessary meta information about the dataremovaladdon hmc extension.
 * 
 * 
 * @version ExtGen v5.1.0.4
 */
public class DataremovaladdonHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(DataremovaladdonHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public final static String RESOURCE_PATH = "com.accenture.hmc.locales";
